                ...
                <div class="card card-body">
                    <form action="" method="get">
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-2">
                                <label for="">Отработано:</label>
                                <select name="worked" class="form-control">
                                    <option value="">Не указано</option>
                                    <option value="0" @if($worked === "0") selected @endif>Нет</option>
                                    <option value="1" @if($worked === "1") selected @endif>Да</option>
                                </select>
                            </div>
                    ...
                    @foreach($bills as $bill)
                        ...
                        <div class="col-md-4 my-2" style="position:relative;">
                            ...
                            <div style="position: relative"
                                ...
                                <div class=" card-title" style="font-size: 16pt"><a class="text-primary" style="z-index: 9999999"
                                ...
                                <div style="position:absolute;top: 10px;right: 10px" class="text-right">
                                    <ul style="font-size: 12px">
                                        ...
                                        @endif
                                        @if($bill->worked == 1)
                                            <li class="text-warning">Отработано</li>
                                        @endif
                                    </ul>
                                </div>
                                <hr>
